...
public class DataAccess {
    ...
    public void initializeDB() {
        ...
        try {
             ...
             Socio socio1  = new Socio("ana",  "ana",  "ana@correo.com",  "ES111", 5);
             Socio socio2  = new Socio("borja","pass2","borja@correo.com","ES222", 3);
             Socio socio3  = new Socio("asdd", "asdd", "asd@correo.com",   "ES333",10);
             Socio socio4  = new Socio("asd",  "asd",  "asd@correo.com",   "ES444",20);
             Socio socioz  = new Socio("z",    "z",    "z@correo.com",     "ESZ", 10);
             Socio sociozz = new Socio("zz",   "zz",   "zz@correo.com",    "ESZZ",10);
             Socio sociozzz= new Socio("zzz",  "zzz",  "zzz@correo.com",   "ESZZZ",10);

             socio3.setAdmin(true);
             ...
             Factura factura1 = new Factura("F-" + System.currentTimeMillis(), now, socio1);
             factura1.meterReserva(null, 10.0);
             factura1.meterReserva(null, 10.0);
